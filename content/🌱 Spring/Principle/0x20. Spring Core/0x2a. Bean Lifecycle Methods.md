...
updated: 2025-04-03
dg-publish: true
title: 0x2a. Bean Lifecycle Methods
---
...
Bean 의 scope 를 Prototype 으로 설정해놓았다면 [[0x2b. Bean Scopes#2. Prototype|여기에서]] 작성된 것처럼, Bean instantiated 다음에 더이상 Spring Container 가 관리하지 않는다. 실제로 Prototype 으로 scope 를 지정하고 test 해보면,
