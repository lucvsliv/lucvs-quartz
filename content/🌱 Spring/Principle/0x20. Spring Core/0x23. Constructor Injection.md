...
updated: 2025-04-03
dg-publish: true
title: 0x23. Constructor Injection
---
...
이런 역할을 내부적으로 수행하는 것이 바로 Spring IoC Container, 위에서 언급한 Spring Container 이다. Spring Container 는 [[🌱-Spring/Principle/0x20. Spring Core/0x21. Inversion of Control#Spring Container|Spring Container]] 부분에서 언급한 것처럼 object 를 만들고, dependency 를 injection 하는 역할을 수행한다. 따라서 Spring IoC Container 는 내부적으로 아래의 코드를 수행하는 것이다.
