...
![[Pasted image 20250328022627.png]]
...
```
Actuator Properties 에서는 [[0x01. Spring Boot Quick Start#Securing Endpoints - Test Result|Actuator]] 부분에서 본 것처럼, endpoints 를 추가 및 제외하거나 Actuator endpoints 의 base path 를 지정할 수 있다.
